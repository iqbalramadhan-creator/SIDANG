<ul class="breadcrumb">
	...
	<li class="active">Laporan Data Barang Keluar</li>
</ul>
        ...
        <h5>Pengelolaan data barang keluar di gudang CV. Deschino Sport</h5>             
            ...
            <div class="panel panel-default">
                ...
                <?php if ($this->session->userdata('posisi')=="Administrator" || $this->session->userdata('posisi')=="Operator") { ?>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <form action="<?php echo base_url() ; ?>index.php/laporan/cetakbarangkeluar" method="post" target="_blank">
                            <input type="hidden" name="tgl_masuk" class="form-control" value="<?=$tahun; ?>" / required>
                        ...
                        <div class="col-md-3">
                        <form method="post" action="<?php echo base_url();?>index.php/laporan/cetak_barangkeluar" >
