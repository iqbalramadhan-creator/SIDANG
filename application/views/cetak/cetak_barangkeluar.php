...
<body>
    ...
    <div class="col-md-12">
      ...
      <!--<ul class="breadcrumb">
        <li><h3 style="color: #ff5a0b"><b>CETAK LAPORAN BARANG KELUAR GUDANG</li></h3><BR></b>
        <li><h4 style="color: #ff0000"><b>CV. DESCHINO SPORT</li></h4></b>
      </ul>-->
      <br/><br/> 
         <p style="font-size:28px; color:black; font-family:algerian">CETAK LAPORAN BARANG KELUAR GUDANG <br><BR>CV. DESCHINO SPORT</p>
      <HR>
    </div>
    </div>
     <br><br><br><br>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                ...
                <div class="panel-body">
                  <form method="post" action="<?php echo base_url();?>index.php/laporan/cetak_barangkeluar" ><br/>
